...
### Getting `sessionid`
- Getting your `sessionid` works the same way on both the China site (Jimeng) and international sites (Dreamina) — If you don’t know how, ask AI.
...
#### Method 1: Docker Compose Local Build (Recommended)
...
1. **Ensure the jimeng2api service is running**:
```bash
...
- **[jimeng-api](https://github.com/iptag/jimeng-api)** - Thanks to this project for providing an important reference and technical basis for the reverse engineering of the Jimeng API. This project has improved its functionality and architecture based on it.
